...
public class BasicOptimizerProblem implements OptimizerProblem {
    ...
    public BasicOptimizerProblem(Problem problem, Solution solution) {
        ...
        int tempsize = furnitures.size();
        for(int i = lastIndex; i < tempsize; i++) {
            unplacedFurniture.add(furnitures.get(i));
        }

        size = unplacedFurniture.size();
